...
public interface OPCUAService extends ControllerService {
	...
	byte[] getValue(List<String> reqTagname,String[] nsList, String returnTimestamp, String excludeNullValue, String nullValueString, String dataFormat, boolean longTimestamp) throws ProcessException;
